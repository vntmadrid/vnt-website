...
export const order = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Stripe Dashboard URL',
      type: 'url',
      description: 'Quick link to view this payment inside Stripe',
      readOnly: true,
    }),
    defineField({
      name: 'shippoRateId',
      ...
      type: 'string',
      description: 'The selected Shippo shipping rate object ID',
      readOnly: true,
    }),
    defineField({
      ...
      type: 'string',
      description: 'The Shippo purchased label transaction object ID',
      readOnly: true,
    }),
    defineField({
      name: 'shippoLabelUrl',
      title: 'Shippo Label URL',
      type: 'url',
      description: 'URL to download the generated shipping label PDF',
    }),
    defineField({
      name: 'shippoTrackingNumber',
      title: 'Shippo Tracking Number',
      type: 'string',
    }),
    defineField({
      name: 'createdAt',
